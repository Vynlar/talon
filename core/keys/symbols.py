...
symbols = [
    ...
    Symbol("(", ["paren", "L paren", "left paren"], ["laren"]),
    Symbol(")", ["R paren", "right paren"], ["raren"]),
    Symbol("[", None,["brack", "L brack", "bracket", "L bracket", "left bracket", "square", "L square", "left square", "lacket"],),
    Symbol("]", None, ["R brack", "R bracket", "right bracket", "R square", "right square", "racket"]),
    Symbol("/", ["forward slash"], ["slash"]),
    Symbol("\\", None, ["backslash"]),
    Symbol("{", None, ["brace", "L brace", "left brace", "curly bracket", "left curly bracket", "lacer"],),
    ...
    Symbol(">", None, ["rangle", "R angle", "right angle", "greater than", "wrangle"]),
    Symbol("^", None, ["caret"]),
    Symbol("|", None, ["pipe"]),
    Symbol("'", None, ["quote", "apostrophe", "single"]),
    Symbol('"', None, ["dub quote", "double quote", "double"]),
]
